...
exports.formatData = functions.database.ref('/DHT11/Humidity/{pushId}/')
...
exports.formatData1 = functions.database.ref('/DHT11/Temperature/{pushId}/')
    .onCreate((snapshot, context) => {
    const original = snapshot.val();
    const pushId = context.params.pushId;
    console.log(`Detected new measure ${original} with pushId ${pushId}`);
...
exports.formatData2 = functions.database.ref('/DHT11/Light/{pushId}/')
    .onCreate((snapshot, context) => {
    const original = snapshot.val();
    const pushId = context.params.pushId;
    console.log(`Detected new measure ${original} with pushId ${pushId}`);
...
exports.formatData3 = functions.database.ref('/DHT11/SoilMoisture_1/{pushId}/')
    .onCreate((snapshot, context) => {
    const original = snapshot.val();
    const pushId = context.params.pushId;
    console.log(`Detected new measure ${original} with pushId ${pushId}`);
...
exports.formatData4 = functions.database.ref('/DHT11/SoilMoisture_2/{pushId}/')
    .onCreate((snapshot, context) => {
    const original = snapshot.val();
    const pushId = context.params.pushId;
    console.log(`Detected new measure ${original} with pushId ${pushId}`);
